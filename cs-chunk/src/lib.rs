...
pub use cs_embed::TokenEstimator;
...
impl TryFrom<cs_core::Language> for ParseableLanguage {
    type Error = anyhow::Error;

    fn try_from(lang: cs_core::Language) -> Result<Self, Self::Error> {
        match lang {
            cs_core::Language::Python => Ok(ParseableLanguage::Python),
            cs_core::Language::TypeScript => Ok(ParseableLanguage::TypeScript),
            cs_core::Language::JavaScript => Ok(ParseableLanguage::JavaScript),
            cs_core::Language::Haskell => Ok(ParseableLanguage::Haskell),
            cs_core::Language::Rust => Ok(ParseableLanguage::Rust),
            cs_core::Language::Ruby => Ok(ParseableLanguage::Ruby),
            cs_core::Language::Go => Ok(ParseableLanguage::Go),
            cs_core::Language::CSharp => Ok(ParseableLanguage::CSharp),
            cs_core::Language::Zig => Ok(ParseableLanguage::Zig),
            _ => Err(anyhow::anyhow!(
...
pub fn chunk_text(text: &str, language: Option<cs_core::Language>) -> Result<Vec<Chunk>> {
...
pub fn chunk_text_with_model(
    text: &str,
    language: Option<cs_core::Language>,
