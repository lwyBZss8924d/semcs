...
use anyhow::Result;
use cc_core::{SearchMode, SearchOptions};
use cc_index::get_index_stats;
use crossterm::{
...
impl TuiApp {
    ...
    fn start_search<B: Backend>(&mut self, terminal: &mut Terminal<B>) -> Result<()> {
        ...
        let exclude_patterns = cc_core::build_exclude_patterns(
        ...
        let handle = tokio::spawn(async move {
            ...
            let search_progress_callback: cc_engine::SearchProgressCallback =
            ...
            let detailed_indexing_progress_callback: cc_engine::DetailedIndexingProgressCallback =
                Box::new(move |progress: cc_index::EmbeddingProgress| {
            ...
            let result = cc_engine::search_enhanced_with_indexing_progress(
                &options,
