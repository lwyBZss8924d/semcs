...
/// Convert cc_chunk::Chunk to IndexedChunkMeta format
pub fn convert_chunks_to_meta(chunks: Vec<cc_chunk::Chunk>) -> Vec<IndexedChunkMeta> {
    chunks
        .iter()
        .map(|chunk| IndexedChunkMeta {
            span: chunk.span.clone(),
            chunk_type: Some(match chunk.chunk_type {
                cc_chunk::ChunkType::Function => "function".to_string(),
                cc_chunk::ChunkType::Class => "class".to_string(),
                cc_chunk::ChunkType::Method => "method".to_string(),
                cc_chunk::ChunkType::Module => "module".to_string(),
                cc_chunk::ChunkType::Text => "text".to_string(),
            }),
