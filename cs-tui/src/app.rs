...
use anyhow::Result;
use cs_core::{SearchMode, SearchOptions};
use cs_index::get_index_stats;
use crossterm::{
...
impl TuiApp {
    ...
    fn cycle_mode(&mut self) {
        self.state.mode = match self.state.mode {
            ...
            SearchMode::Ast => SearchMode::Semantic, // Skip AST for now
        };
    ...
    fn start_search<B: Backend>(&mut self, terminal: &mut Terminal<B>) -> Result<()> {
        ...
        let exclude_patterns = cs_core::build_exclude_patterns(
        ...
        let handle = tokio::spawn(async move {
            ...
            let search_progress_callback: cs_engine::SearchProgressCallback =
            ...
            let detailed_indexing_progress_callback: cs_engine::DetailedIndexingProgressCallback =
                Box::new(move |progress: cs_index::EmbeddingProgress| {
            ...
            let result = cs_engine::search_enhanced_with_indexing_progress(
                &options,
