...
fn test_basic_grep_functionality() {
    ...
    let output = Command::new(cs_binary())
...
fn test_index_command() {
    ...
    // Check that .cs directory was created
    assert!(temp_dir.path().join(".cs").exists());
}

fn read_manifest_updated(dir: &Path) -> u64 {
    let manifest_path = dir.join(".cs").join("manifest.json");
...
fn test_switch_model_skips_when_same_model() {
    ...
    let status = Command::new(cs_binary())
        .args(["--index", "."])
        .current_dir(temp_dir.path())
        .status()
        .expect("cc --index should run");
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("cc --switch-model should run");
...
fn test_switch_model_force_rebuild() {
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("cc --switch-model --force should run");
...
fn test_semantic_search() {
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("Failed to run cc semantic search");
...
fn test_lexical_search() {
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("Failed to run cc lexical search");
...
fn test_hybrid_search() {
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("Failed to run cc hybrid search");
...
fn test_context_lines() {
    ...
    let output = Command::new(cs_binary())
        ...
        .output()
        .expect("Failed to run cc with context");
...
fn test_topk_limit() {
    ...
    let output = Command::new(cs_binary())
        ...
        .output()
        .expect("Failed to run cc with topk");
...
fn test_line_numbers() {
    ...
    let output = Command::new(cs_binary())
        ...
        .output()
        .expect("Failed to run cc with line numbers");
...
fn test_error_handling() {
    ...
    let _output = Command::new(cs_binary())
...
fn test_jsonl_vs_regular_output() {
    ...
    // Regular output
    let regular_output = Command::new(cs_binary())
        .args(["fn main", temp_dir.path().to_str().unwrap()])
        .output()
        .expect("Failed to run cc");

    // JSONL output
    let jsonl_output = Command::new(cs_binary())
        .args(["fn main", "--jsonl", temp_dir.path().to_str().unwrap()])
        .output()
        .expect("Failed to run cc");
...
fn test_add_file_with_relative_path() {
    ...
    let output = Command::new(cs_binary())
        ...
        .current_dir(temp_dir.path())
        .output()
        .expect("Failed to run cc --add with relative path");
