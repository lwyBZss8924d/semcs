/**
 * Webview script for cc search panel - Crisp UI
...
(function () {
  ...
  const ccignoreButton = document.getElementById('ccignoreButton');
  ...
  if (ccignoreButton) {
    ccignoreButton.addEventListener('click', () => {
      vscode.postMessage({ type: 'openCcignore' });
    });
  }
  ...
  function handleIndexStatus(status) {
    ...
    indexStatus.title = 'cc respects .gitignore, .ccignore, include/exclude filters, and default VS Code excludes';
